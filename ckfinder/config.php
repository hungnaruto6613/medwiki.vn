...
$config['authentication'] = function () {
    return isset($_SESSION['id_nguoidung'])&& $_SESSION['id_loainguoidung']==1;
};
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/medwikisystem/images/tintuc/',
	'root'         => 'C://xampp/htdocs/medwikisystem.vn/images/tintuc', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
