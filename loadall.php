...
$getnhombenh = mysql_query("SELECT DISTINCT id_nhombenh FROM nhombenh ORDER BY id_nhombenh;");
$getnhombenh2 = mysql_fetch_array($getnhombenh);

$idnhombenh = $getnhombenh2[0];
		...
		<div id=\"comment-$cid\" class=\"comment\">
			...
			echo "</div>
				...
				<div id=\"commentoption-$cid\" class=\"commentoption\">";
					...
					{
						echo "
						<button id=\"numlikecomment-$cid\" class=\"likecomment\" style=\"display:none;\"></button>";
					}
